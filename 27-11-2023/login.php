...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if ($num == 1){
        ...
        header("location: /Minor-project-final/afterlogin.php");
    } 
    else{
...
<html lang="en">
  ...
  <header class="header" id="home" style=" height: 100px; width: 100%;">
    ...
    <div class="form-container">
        ...
        <form action="/Minor-project-final/login.php" method="POST">
            ...
            <div class="mainContainer">
                ...
                <!--Register button-->        
                <div class="regi">
                    <p class="register"><a href="/Minor-project-final/signup.php">Register</a></p>
                </div>
            </div>
        </form>
    </div>
    ...
    <div class="pic">
        <img src="img/Logo.jpg"  width="300" height="300" alt="Ballortalk">
    </div>
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            if (isLoggedIn) {
                ...
                if (confirmResubmit) {
                    ...
                    window.location.href = "/Minor-project-final/login.php";
                }
            }
        });
