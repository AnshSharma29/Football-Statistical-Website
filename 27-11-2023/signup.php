...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    if(($password == $cpassword) && $exists==false){
        ...
        if ($result){
            ...
            header("Location: /Minor-project-final/login.php");
            exit;
        }
    }
  ...
  <body>
    ...
    ?>
        ...
        <div class="form-container">
            <form class= "form" action="/Minor-project-final/signup.php" method="POST">
                <!--Heading-->
                ...
                <div class="mainContainer">
                    ...
                    <!--Back to Login page-->
                    <div align="center">
                        <a href= "/Minor-project-final/login.php"><button type="button">Back to Login page</button></a>
                    </div>
